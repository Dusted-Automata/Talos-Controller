...
// float
// MotionProfile::update(float setpoint)
// {
...
//
//         // Check if finished
//         isFinished = static_cast<long>(position * (10 ^ compFactor)) == static_cast<long>(setpoint * (10 ^
//         compFactor));
...
//
void
MotionProfile::stateCalculation()
{
...
void
MotionProfile::calculateConstantVelocityProfile(float setpoint)
{
...
void
MotionProfile::calculateTrapezoidalProfile(float setpoint)
{
...
// Getters and setters
bool
MotionProfile::getFinished()
{
    return isFinished;
}

void
MotionProfile::setMaxVelocity(float aMaxVelocity)
{
    maxVelocity = aMaxVelocity;
}

void
MotionProfile::setMaxAcceleration(float aMaxAcceleration)
{
    maxAcceleration = aMaxAcceleration;
}

void
MotionProfile::setCompFactor(int aFactor)
{
    compFactor = aFactor;
}
