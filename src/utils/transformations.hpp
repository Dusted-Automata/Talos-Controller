...
//  */
// inline Eigen::Matrix3d
// ecef2ned_matrix(const Ecef &ref_ecef)
// {
...
//  */
// inline Vector3d
// wgsecef2ned(const Ecef &ecef, const Ecef &ref_ecef)
// {
//     // double M[3][3];
...
//  */
// inline Vector3d
// wgsecef2ned_d(const Ecef &ecef, const Ecef &ref_ecef)
// {
...
//  */
// inline Vector3d
// wgsned2ecef(const Eigen::Vector3d &ned, const Ecef &ref_ecef)
// {
//     Eigen::Matrix3d M = ecef2ned_matrix(ref_ecef);
//     Ecef ecef = M.transpose() * ned;
//     return ecef;
// }
//
...
//  */
// inline Ecef
// wgsned2ecef_d(const Eigen::Vector3d &ned, const Ecef &ref_ecef)
// {
//     Ecef ecef = wgsned2ecef(ned, ref_ecef);
//     ecef = ecef + ref_ecef;
//     return ecef;
// }
