 ...
 */
inline void enu2uvw(double et, double nt, double up, double lat, double lon, double &out_u,
 ...
 * @brief Internal function used in conversions certain coordinate conversions
 */
inline void uvw2enu(double u, double v, double w, double lat, double lon, double &out_east,
                    double &out_north, double &out_up)
{
 ...
 *
 */
inline void ecef2geodetic_you(double x, double y, double z, double &out_lat, double &out_lon,
                              double &out_alt, Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 * the Earth.
 */
inline void ecef2geodetic_olson(double x, double y, double z, double &out_lat, double &out_lon,
                                double &out_alt, Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 */
inline void ecef2geodetic(double x, double y, double z, double &out_lat, double &out_lon,
                          double &out_alt, Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void enu2aer(double east, double north, double up, double &out_az, double &out_el,
                    double &out_range)
{
 ...
 *
 */
inline void aer2ned(double az, double el, double range, double &out_north, double &out_east,
                    double &out_down)
{
 ...
 */
inline void geodetic2ecef(double lat, double lon, double alt, double &out_x, double &out_y,
                          double &out_z, Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void ecef2enu(double x, double y, double z, double lat, double lon, double alt,
                     double &out_east, double &out_north, double &out_up,
 ...
 *
 */
inline void ecef2aer(double x, double y, double z, double lat, double lon, double alt,
                     double &out_az, double &out_el, double &out_range,
                     Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
    double e, n, u;
 ...
 *
 */
inline void ecef2ned(double x, double y, double z, double lat, double lon, double alt,
                     double &out_north, double &out_east, double &out_down,
                     Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void enu2ecef(double east, double north, double up, double lat, double lon, double alt,
 ...
 *
 */
inline void enu2geodetic(double east, double north, double up, double lat, double lon, double alt,
 ...
 *
 */
inline void geodetic2enu(double lat, double lon, double alt, double lat0, double lon0, double alt0,
                         double &out_east, double &out_north, double &out_up,
                         Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
    double x1, y1, z1;
 ...
 *
 */
inline void geodetic2aer(double lat, double lon, double alt, double lat0, double lon0, double alt0,
                         double &out_az, double &out_el, double &out_range,
                         Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
    double e, n, u;
 ...
 *
 */
inline void geodetic2ned(double lat, double lon, double alt, double lat0, double lon0, double alt0,
                         double &out_north, double &out_east, double &out_down,
                         Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void aer2ecef(double az, double el, double range, double lat, double lon, double alt,
                     double &out_x, double &out_y, double &out_z,
                     Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
    double x, y, z;
 ...
 *
 */
inline void aer2geodetic(double az, double el, double range, double lat, double lon, double alt,
                         double &out_lat, double &out_lon, double &out_alt,
                         Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
    double x, y, z;
 ...
 *
 */
inline void ned2ecef(double north, double east, double down, double lat, double lon, double alt,
                     double &out_x, double &out_y, double &out_z,
                     Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void ned2geodetic(double north, double east, double down, double lat, double lon, double alt,
                         double &out_lat, double &out_lon, double &out_alt,
                         Ellipsoid ellipsoid = Ellipsoid::WGS84)
{
 ...
 *
 */
inline void ned2aer(double north, double east, double down, double &out_az, double &out_el,
                    double &out_range)
{
